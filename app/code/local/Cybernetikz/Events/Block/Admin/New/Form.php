...
class Cybernetikz_Events_Block_Admin_New_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
	...
	protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('new_tip', array('legend' => Mage::helper('events')->__('Event Details')));
 
        $fieldset->addField('name', 'text', array(
            'name'      => 'name',
            'title'     => Mage::helper('events')->__('Event Name'),
		...
		//echo Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_SHORT);
        ...
        $contentField = $fieldset->addField('content', 'editor', array(
            'name'      => 'content',
			'title'     => Mage::helper('events')->__('Event Description'),
