...
class Cybernetikz_Ads_Block_Admin_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	/**
	...
	protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('edit_tip', array('legend' => Mage::helper('ads')->__('Ads Details')));
 
        $fieldset->addField('ads_id', 'hidden', array(
            'name'      => 'ads_id'
        ));
