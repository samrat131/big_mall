...
class Cybernetikz_Videos_Block_Admin_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
	/**
	...
	protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('edit_tip', array('legend' => Mage::helper('videos')->__('Video Details')));
